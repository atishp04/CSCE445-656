...
public class CanvasClass extends View implements OnTouchListener{
	...
	BufferedWriter out;
	PlayScreen canObj=null;
	private static final String TAG = "DrawView";
	public CanvasClass(Context context,PlayScreen conObj) {
		super(context);
		canObj=conObj;
		...
		globalvariable.paint.setStrokeCap(Paint.Cap.SQUARE);
		globalvariable.paint.setStrokeWidth(25); 
